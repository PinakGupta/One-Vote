...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!userId || !userRole) {
        throw new Error("User ID or Role missing in response.");
      }
      ...
      navigate(
        userRole === "user" ? `/${userId}` : `/admin/${userId}/election`
      );
    ...
    <div id="login">
      ...
      <div className="log">
        ...
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          {/* Buttons in same line with same size and styling */}
          <div className="button flex flex-row gap-6 mt-10">
            <button
              type="submit"
              className="text-2xl py-4 px-10 bg-blue-500 text-white rounded hover:bg-blue-600 transition-all"
            >
              <span>Login</span>
            </button>
            <Link to="/">
