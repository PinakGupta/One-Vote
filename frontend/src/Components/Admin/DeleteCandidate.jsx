...
// //                 }
// //             });
// //             setCandidates(response.data.data || []); // Assuming response.data.data contains candidates
// //             setError('');
// //         } catch (err) {
// //             setError(err.response?.data?.message || 'Failed to fetch candidates');
// //             setCandidates([]);
...
// //         try {
// //             const token = localStorage.getItem('accessToken');
// //             await api.delete(`${server}/admin/election/${electionId}/candidates/${candidateId}`, {
// //                 headers: {
// //                     Authorization: `Bearer ${token}`
// //                 }
// //             });
...
//             const fetchedCandidates = response.data.data || response.data.candidates || [];
...
//             alert('Candidate removed successfully');
//         } catch (error) {
//             console.error('Delete Error:', error.response || error); // Debug error
//             setError(error.response?.data?.message || 'Failed to delete candidate');
//         }
//     };
...
//                                             alt={`${candidate.firstName} ${candidate.lastName}`}
//                                             className="w-full h-full object-cover"
//                                             onError={() => console.log(`Failed to load image for ${candidate.firstName}`)}
//                                         />
//                                     </div>
//                                     <h3 className="text-xl font-bold text-center">
//                                         {candidate.firstName} {candidate.lastName}
