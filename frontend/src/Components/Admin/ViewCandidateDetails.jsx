...
/**
 * ViewCandidateDetails component for displaying a candidate's details.
 * Fetches and renders candidate information for a specific election.
 */
function ViewCandidateDetails() {
  ...
  // Fetch candidate details on mount or candidateId change
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          ...
          style={{ boxShadow: '0 0 40px rgba(88, 88, 255, 0.15)' }}
        >
          {/* Header with profile */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-lg">{candidate.email || 'N/A'}</p>
              </div>
            </div>
            <div className="space-y-5">
