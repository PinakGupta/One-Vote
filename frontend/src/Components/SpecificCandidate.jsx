    ...
    const fetchCandidate = async () => {
      try {
        ...
        const voteStatusResponse = await axios.get(
          `${server}/elections/check-vote-status/${userId}/${electionId}`
        );
        setHasVoted(voteStatusResponse.data.hasVoted);

        // Get candidate details
        const candidateResponse = await axios.get(
          `${server}/candidates/candidate-list/candidate/${candidateId}`
        );
            ...
            <div className="bg-gray-900 rounded-3xl overflow-hidden border border-gray-800 shadow-xl hover:shadow-blue-900/20 transition-all duration-500">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center mb-6">
                  <span className="px-3 py-1 bg-blue-900 bg-opacity-50 rounded-full text-blue-300 text-sm">
